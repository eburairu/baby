                    ...
                    <div className="flex gap-2 overflow-x-auto pb-1">
                        {images.map((url) => (
                            <button
                                ...
                                className="relative flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 dark:focus-visible:ring-amber-500 dark:focus-visible:ring-offset-zinc-900"
                                aria-label="写真を拡大"
                            >
                                <Image
                                    src={url}
