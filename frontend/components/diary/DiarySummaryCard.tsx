                    ...
                    <div className="flex gap-2 overflow-x-auto pb-1">
                        {images.map((url) => (
                            <button
                                ...
                                className="relative flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 dark:focus-visible:ring-amber-500 focus-visible:ring-offset-2 hover:opacity-90 active:scale-95 transition-all"
                                aria-label="写真を拡大"
                            >
                                <Image
                                    src={url}
