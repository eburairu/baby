...
- [ ] `frontend/components/note/NoteForm.tsx`: ボタン・ラベルに追加
- [ ] `frontend/components/settings/SettingsHeader.tsx`: タイトルに追加
- [ ] `frontend/components/diary/DiaryEditDialog.tsx`: タイトル・ボタンに追加
- [ ] `frontend/components/ContractionTimer.tsx`: ステータス・ボタンに追加
- [ ] `frontend/components/feeding/feeding-history.tsx`: 削除ダイアログに追加
- [ ] `frontend/components/sleep/sleep-history.tsx`: 削除・編集ダイアログに追加
- [ ] `frontend/components/diaper/DiaperHistory.tsx`: 削除ダイアログに追加
- [ ] `frontend/components/diaper/DiaperEditDialog.tsx`: 編集ダイアログに追加
- [ ] `frontend/components/growth/GrowthHistoryList.tsx`: 削除ダイアログに追加
- [ ] `frontend/components/note/NoteHistory.tsx`: 削除・編集ダイアログに追加
